    ...
    return (
      <div className="flex items-center gap-3 px-4 py-2 bg-white/5 border border-white/10 rounded-lg text-sm">
        ...
        <div className="flex items-center gap-2 text-gray-300">
          ...
          <span>Free: <span className="text-white font-semibold">{user?.freeGenerationsLeft || 0}/3</span></span>
        </div>
        ...
        <div className="flex items-center gap-2 text-gray-300">
          ...
          <span>Credits: <span className="text-green-400 font-semibold">{displayCredits}</span></span>
        </div>
      </div>
    );
  }
